...
class _MyRecordState extends State<MyRecord> {
  ...
  bool _isCalenderOpen = false;

  void _updateContent(int index, bool isCalenderOpen) {
    setState(() {
      _selectedIndex = index;
      _isCalenderOpen = isCalenderOpen;
    });
  }
          ...
          Row(
            ...
            children: [
              ...
              OutlinedButton(
                ...
                child: Text('이번 주', style: TextStyle(
                  fontSize: 12,
              ...
              OutlinedButton(
                ...
                child: Text('이번 달', style: TextStyle(
                  fontSize: 12,
              ...
              OutlinedButton(
                onPressed: (){
                  ...
                  } else if (_selectedIndex == 4 && _isCalenderOpen == true) {
                    return _updateContent(4, false);
                  } else if (_selectedIndex == 4 && _isCalenderOpen == false) {
                    return _updateContent(4, true);
                  }
                },
                child: Icon(Icons.calendar_today,
                  color: _isCalenderOpen == true ? MAIN_COLOR : SERVEONE_COLOR,)
              ),
            ],
          ),
          MyRecordContents(selectedIndex: _selectedIndex, isCalenderOpen: _isCalenderOpen)
        ],
      );
    }
  }
  ...
  class MyRecordContents extends StatefulWidget {
    ...
    final bool isCalenderOpen;

    const MyRecordContents({Key? key, required this.selectedIndex, required this.isCalenderOpen}) : super(key: key);
                    ...
                    : widget.selectedIndex == 3
                      ? Text('인덱스 3임', style: TextStyle(color: Colors.white))
                        : widget.selectedIndex == 4
                          ? Text('인덱스 4임', style : TextStyle(color: Colors.white))
                            : Text('잘못된 인덱스')
        ],
      );
    }
...
class TableCalenderScreen extends StatefulWidget {
  const TableCalenderScreen({Key? key}) : super(key: key);
  @override
